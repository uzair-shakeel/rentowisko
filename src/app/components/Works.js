    ...
    <div className=" py-12">
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center py-8 space-y-6 md:space-y-0 md:space-x-10">
          <div className="flex md:flex-col items-center mx-10 md:mx-0">
            ...
            <h3 className=" text-[10px] text-end md:text-center order-1 w-1/3 md:w-full md:order-2 md:text-[18px] font-[700] leading-[28px] py-2 md:py-5">
              Choose location
            </h3>
            <p className="text-[#6B6868] text-start md:text-center order-3 w-1/3 md:w-[60%] text-[10px] md:text-[14px] font-[700] leading-[21px] mx-auto">
