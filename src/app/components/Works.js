  ...
  return (
    <div className=" py-12">
      <div className="container mx-auto text-center">
        ...
        <h2 className="text-[10px] md:text-[16px] font-[700] text-[#8F8C8C] mb-2">
          HOW IT WORK
        </h2>
        <h1 className="text-[12px] md:text-[28px] font-[700] mb-8">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center py-8 space-y-6 md:space-y-0 md:space-x-10">
          <div className="flex flex-col items-center">
            ...
            <h3 className=" text-[10px] md:text-[18px] font-[700] leading-[28px] py-2 md:py-5">
              Choose location
            </h3>
            <p className="text-[#6B6868] text-[10px] md:text-[14px] font-[700] leading-[21px] w-[60%] mx-auto">
              Choose your location and find your best car
            </p>
          </div>
          <div className="flex flex-col items-center">
            <div className="bg-[#629FFD] shadow-md  p-4 flex items-center justify-center rounded-2xl h-[55px] md:h-[100px] w-[55px] md:w-[100px] mb-3">
              <img
                src="/Notepad.svg"
                alt="Location"
                className="h-[25px] md:h-[50px] w-auto text-[#E9F5FE]"
              />
            </div>
            <h3 className="text-[10px] md:text-[18px] font-[700] leading-[28px] py-2 md:py-5">
              Customize you Plan{" "}
