            ...
            <div className="px-4 md:hidden block">
              ...
              <div className="flex flex-col items-center justify-center gap-2 ">
                <div className="flex-1 flex flex-col items-start gap-1 w-full bg-white p-2 rounded-md">
                  ...
                  <select className="bg-transparent pl-1 text-[13px] leading-[15px] text-[#5E5A5A] font-medium outline-none custom-select">
                    <option>Select</option>
                    <option>0-10</option>
                    <option>10-20</option>
                    <option>20-50</option>
                ...
                <div className="flex-1 flex  items-start gap-1 w-full flex-col bg-white p-2 rounded-md">
                  ...
                  <select className="bg-transparent pl-1 text-[13px] leading-[18px] text-[#5E5A5A] font-medium outline-none custom-select">
                    <option>Select</option>
                    <option>0-10</option>
                    <option>10-20</option>
                    <option>20-50</option>
