...
const CarDetails = () => {
  ...
  const boxesToShow = showMore ? carInfoData.length : (screenWidth >= 768 ? defaultBoxes.desktop : defaultBoxes.mobile);
    ...
    <div>
      ...
      <div className="py-[30px] sm:py-[53px] bg-white rounded-[15px] shadow-lg flex flex-col gap-4">
        <div className="md:flex hidden items-center justify-between w-full px-[30px]">
          <div>
            <h2 className="text-[#131111] text-[28px] leading-[42px] font-bold font-inter">BMW E46</h2>
            <h4 className="text-[#8F8C8C] text-[20px] font-medium font-inter leading-[30.5px]">Hybrid</h4>
          </div>
          <h2 className="text-[#629FFD] text-[28px] leading-[42px] font-bold font-inter">120$/Day</h2>
        </div>
        <div className="max-w-[920px] mx-auto w-full px-5 my-[20px]">
          <Image src="/car-s.svg" alt="Main Car" width={900} height={376} className="w-full rounded-[15px]" />
      ...
      <div className="mt-7 border-2 border-[#6B686821] w-full rounded-[15px] bg-white px-5 sm:px-9 pt-[24px] pb-7">
        ...
        <div className="flex items-center gap-12">
          <button
            className={`text-[15px] sm:text-[20px] leading-[30px] font-inter px-1 sm:px-2 ${activeTab === 'overview'
          ...
          <button
            className={`text-[15px] sm:text-[20px] leading-[30px] font-inter  px-1 sm:px-2 ${activeTab === 'rental'
              ? 'text-[#629FFD] font-bold border-b-4 border-[#629FFD]'
              : 'text-[#6B6868] font-medium'
              }`}
          ...
          <button
            className={`text-[15px] sm:text-[20px] leading-[30px] font-inter  px-1 sm:px-2 ${activeTab === 'reviews'
              ? 'text-[#629FFD] font-bold border-b-4 border-[#629FFD]'
              : 'text-[#6B6868] font-medium'
              }`}
        ...
        <div className="mt-8">
          {activeTab === 'overview' && (
            <div>
              <p className="text-[#6B6868] text-[12px] sm:text-[20px] sm:leading-[30px] font-inter font-medium">
                The 718 models were made for the sport of it. They are mid-engined roadsters that unite the sporting spirit of the legendary Porsche 718 with the sports car of tomorrow.
                <span
                  ref={contentRef}
                  className={`block transition-max-height duration-500 ease-in-out overflow-hidden ${isExpanded ? 'max-h-40' : 'max-h-0'}`}
                >
                  This is the additional text that is shown when the user clicks "Read More." You can add more detailed information here about the car's features, history, or anything else relevant.
                </span>
              </p>
              <button
          ...
          {activeTab === 'rental' && (
            <div>
              <p>Rental details will be displayed here.</p>
            </div>
          )}
          {activeTab === 'reviews' && (
            <div>
      ...
      <div className="mt-7 border-2 border-[#6B686821] w-full rounded-[15px] bg-white px-5 sm:px-9 pt-[24px] pb-3.5">
        ...
        <div className="flex items-center justify-center mt-[30px]">
          ...
          >
            <Image src='/angle-double-right.svg' alt="angle-double-right" width={18} height={18} />
            {showMore ? 'Less' : 'More'}
          </button>
        </div>
      </div>
      ...
      <div className="mt-7 border-2 border-[#6B686821] w-full rounded-[15px] bg-white px-5 sm:px-9 pt-[34px] pb-10 sm:pb-20">
        <div className="text-[#131111] text-[20px] leading-[30px] font-inter font-bold mb-10">More Information</div>
        <table className="w-full mt-2 text-left">
          <tbody>
            <tr className="border-b border-[#6B686821]">
              <td className="text-[#131111]  text-[15px] sm:text-[20px] sm:leading-[30px] font-semibold font-inter">Color</td>
              <td className="text-right text-[#131111]  text-[15px] sm:text-[20px] sm:leading-[30px] font-semibold font-inter pb-1.5 text-nowrap">Silver Metallic</td>
            </tr>
            <tr className="border-b border-[#6B686821]">
              <td className="text-[#131111] text-[15px] sm:text-[20px] sm:leading-[30px] font-semibold font-inter">Combined fuel consumption/emissions in 1/100 km</td>
              <td className="text-right text-[#131111]  text-[15px] sm:text-[20px] sm:leading-[30px] font-semibold font-inter py-1.5">11.1</td>
            </tr>
            <tr className="border-b border-[#6B686821]">
              <td className="text-[#131111]  text-[15px] sm:text-[20px] sm:leading-[30px] font-semibold font-inter">CO2 emissions comb. in g/km</td>
              <td className="text-right text-[#131111]  text-[15px] sm:text-[20px] sm:leading-[30px] font-semibold font-inter py-1.5">251</td>
            </tr>
          </tbody>
        </table>
      </div>
