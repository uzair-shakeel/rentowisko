...
export default function Choose() {
  return (
    <div className="bg-white py-12">
      <div className="container mx-auto flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-12">
        <div className="flex-1">
          <img src="/main-car.png" alt="Main Car" className="max-w-full" />
        ...
        <div className="flex-1 w-[35%]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold">Power of AI</h3>
                <p className="text-gray-600">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold">24-hour car delivery</h3>
                <p className="text-gray-600">
